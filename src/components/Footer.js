...
const Footer = () => {
  return (
    <footer className="footer bg-base-200 footer-center xs:p-10 py-10 xs:py-0 xs:px-0 text-base-content rounded">
      <div className="xs:grid xs:grid-flow-col xs:gap-4 grid grid-cols-3 xs:grid-cols-1 gap-4">
